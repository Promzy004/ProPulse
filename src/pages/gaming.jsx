...
import img from '../components/assets/images/vecteezy_3d-render-game-equipment-console-headset_13361342.png'
            ...
            <div>
                ...
                <div className="index-sort">
                    ...
                    <div className="products">
                        {all_products.filter(items => items.category === 'Gaming').map((items,index) => {
